...
var tyche = {
    ...
    pbur: {}, // Price by User Role for WooCommerce.
                ...
                reasons.forEach(function (item) {
                    html += `
						<li
							...
							data-input-type="${escHtml(tyche.plugin_deactivation.fn.return(item, "input_type"))}"
							data-input-placeholder="${escHtml(tyche.plugin_deactivation.fn.return(item, "input_placeholder"))}">
								<label>
									<span>
										<input type="radio" name="selected-reason" value="${escHtml(tyche.plugin_deactivation.fn.return(
                                            item,
                                            "id"
                                        ))}" />
									</span>
									<span>
										${escHtml(tyche.plugin_deactivation.fn.return(item, "text"))}
									</span>
								</label>
							${
        ...
        events: {
            ...
            button_submit: function ($this, $data, plugin, skip = false) {
                if (
                    ...
                    !jQuery($this).hasClass("allow-deactivate")
                ) {
                    return;
                }
